...
button.addEventListener("click", function (event) {
  ...
  if ((Name1SoulUrgeNumber > 0) & (Name2SoulUrgeNumber > 0)) {
    ...
    if (lovePercent >= 90) {
      // console.log();
      const arrOf90 = ["നിങ്ങൾ True lub ആണോ.... 😁","നീ ഒരു കില്ലാടി തന്നെ.......😱😱"]
      var comments = arrOf90[Math.floor(Math.random() * arrOf90.length)];
      comment.innerHTML = `${comments}`;
    } else if (lovePercent >= 75) {
      const arrOf75 = ["വരുന്നെടാ RUMANTIC വരുന്നെടാ...🥰","ഇതൊക്കെ എന്ത് .......😉😉😉","മുതലാളി ജങ്ക ജക ജക ....... 🤩"]
      ...
      const arrOf30 = ["യോഗല്ല്യമ്മിണ്യേ പായ അങ്ങട് മടക്ക്യാള....🤭","നിന്റെ കണ്ണീരിന്റെ ഉപ്പ്  ഈ മജ്‌ലിസിന്  വേണ്ട മേരി.....","ഇൻസൾട്ട് ആണ് മുരളി Life le ഏറ്റവും വലിയ investment....","Don't Worry Kido 7 bilion pepole in this world","ഇപ്പോ എങ്ങനിരിക്കണ്......😐"]
